                            ...
                            <div class="container mt-sm-5 my-1 shadow-lg bg-white rounded">
                                <div class="question ml-sm-5 pl-sm-5 pt-2">
                                    ...
                                    <form action="../includes/answers.php" method="post">
                                            ...
                                            <label class="options"><?php echo $quest['answer1']?> <input type="radio" name="answer" id="answer" value="<?php echo $quest['answer1']?>" > <span class="checkmark"></span> </label> 
                                            <label class="options"><?php echo $quest['answer2']?> <input type="radio" name="answer" id="answer" value="<?php echo $quest['answer2']?>" > <span class="checkmark"></span> </label> 
                                            <label class="options"><?php echo $quest['answer3']?> <input type="radio" name="answer" id="answer" value="<?php echo $quest['answer3']?>" > <span class="checkmark"></span> </label> 
                                            <label class="options"><?php echo $quest['answer4']?> <input type="radio" name="answer" id="answer" value="<?php echo $quest['answer4']?>" > <span class="checkmark"></span> </label>
