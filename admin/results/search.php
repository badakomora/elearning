...
results.id as rid, results.a_id, results.marks, results.attempt
FROM users
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left p-1" style="display:none" id="mySidebar">
  ...
  <hr>
  <a href="../departments/"class="w3-bar-item w3-button"><i class="fa fa-home"></i> Departments</a>
  ...
  <a href="./" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i> Results</a>
