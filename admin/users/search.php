                                    ...
                                    <div class="modal-body">
                                         <div class="mb-3">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <select id="inputState" name="staff" class="form-control">
                                                    <option selected>Update User Role :  <?php echo $row['staff']; ?></option>
                                                    <hr>
                                                    <option value="1">Normal User : 1</option>
                                                    <option value="0">Faculty Administrator : 0</option>
                                                </select>
                                            </div>
